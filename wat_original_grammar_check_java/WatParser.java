...
public class WatParser extends Parser {
	...
	public static final int
		...
		INPUT=183, OUTPUT=184, NAN_=185, VAR=186, SPACE=187, LCOMMENT=188, RCOMMENT=189, 
		COMMENT=190;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'table.copy'", "'table.init'", "'data.drop'", "'elem.drop'", null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NAN_", "VAR", "SPACE", "LCOMMENT", "RCOMMENT", "COMMENT"
		};
	}
