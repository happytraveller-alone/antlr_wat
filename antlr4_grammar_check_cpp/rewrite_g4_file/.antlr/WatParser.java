...
public class WatParser extends Parser {
	...
	public static final int
		...
		FINAL=36, REC=37, REF_NULL=38, REF_FUNC=39, REF_STRUCT=40, REF_ARRAY=41, 
		REF_HOST=42, REF_EXTERN=43, REF_IS_NULL=44, REF_AS_NON_NULL=45, REF_TEST=46, 
		REF_CAST=47, REF_EQ=48, REF_I31=49, I31_GET=50, STRUCT_NEW=51, STRUCT_GET=52, 
		STRUCT_SET=53, ARRAY_NEW=54, ARRAY_NEW_FIXED=55, ARRAY_NEW_ELEM=56, ARRAY_NEW_DATA=57, 
		ARRAY_GET=58, ARRAY_SET=59, ARRAY_LEN=60, ARRAY_COPY=61, ARRAY_FILL=62, 
		ARRAY_INIT_DATA=63, ARRAY_INIT_ELEM=64, EXTERN_CONVERT=65, NOP=66, UNREACHABLE=67, 
		DROP=68, BLOCK=69, LOOP=70, END=71, BR=72, BR_IF=73, BR_TABLE=74, RETURN=75, 
		IF=76, THEN=77, ELSE=78, SELECT=79, CALL=80, CALL_INDIRECT=81, CALL_REF=82, 
		RETURN_CALL=83, RETURN_CALL_REF=84, RETURN_CALL_INDIRECT=85, BR_ON_NULL=86, 
		BR_ON_CAST=87, LOCAL_GET=88, LOCAL_SET=89, LOCAL_TEE=90, GLOBAL_GET=91, 
		GLOBAL_SET=92, TABLE_GET=93, TABLE_SET=94, TABLE_SIZE=95, TABLE_GROW=96, 
		TABLE_FILL=97, TABLE_COPY=98, TABLE_INIT=99, DATA_DROP=100, ELEM_DROP=101, 
		LOAD=102, STORE=103, OFFSET_EQ_NAT=104, ALIGN_EQ_NAT=105, UNARY=106, BINARY=107, 
		TEST=108, COMPARE=109, CONVERT=110, VEC_LOAD=111, VEC_STORE=112, VEC_LOAD_LANE=113, 
		VEC_STORE_LANE=114, VEC_UNARY=115, VEC_BINARY=116, VEC_TERNARY=117, VEC_TEST=118, 
		VEC_BITMASK=119, VEC_SHIFT=120, VEC_SHUFFLE=121, VEC_SPLAT=122, VEC_EXTRACT=123, 
		VEC_REPLACE=124, MEMORY_SIZE=125, MEMORY_GROW=126, MEMORY_FILL=127, MEMORY_COPY=128, 
		MEMORY_INIT=129, TYPE=130, FUNC=131, START_=132, PARAM=133, RESULT=134, 
		LOCAL=135, GLOBAL=136, TABLE=137, MEMORY=138, ELEM=139, DATA=140, OFFSET=141, 
		IMPORT=142, EXPORT=143, DECLARE=144, ITEM=145, MODULE=146, BIN=147, QUOTE=148, 
		SCRIPT=149, REGISTER=150, INVOKE=151, GET=152, ASSERT_MALFORMED=153, ASSERT_INVALID=154, 
		ASSERT_UNLINKABLE=155, ASSERT_RETURN=156, ASSERT_TRAP=157, ASSERT_EXHAUSTION=158, 
		INPUT=159, OUTPUT=160, NAN=161, VAR=162, SPACE=163, COMMENT=164;
	public static final int
	...
	public final Export_descContext export_desc() throws RecognitionException {
		...
		try {
			...
			setState(1086);
			_la = _input.LA(1);
			if ( !(((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & 225L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
