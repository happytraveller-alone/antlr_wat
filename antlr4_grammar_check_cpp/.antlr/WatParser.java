...
public class WatParser extends Parser {
	...
	public static final int
		...
		EITHER=158, THREAD=159, WAIT=160, SCRIPT=161, REGISTER=162, INVOKE=163, 
		GET=164, ASSERT_MALFORMED=165, ASSERT_INVALID=166, ASSERT_UNLINKABLE=167, 
		ASSERT_RETURN=168, ASSERT_TRAP=169, ASSERT_EXHAUSTION=170, INPUT=171, 
		OUTPUT=172, NAN_=173, VAR=174, SPACE=175, COMMENT=176;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MODULE", "BIN", "QUOTE", "EITHER", "THREAD", "WAIT", "SCRIPT", "REGISTER", 
			"INVOKE", "GET", "ASSERT_MALFORMED", "ASSERT_INVALID", "ASSERT_UNLINKABLE", 
