...
#include "../common/JavaScriptLexer.h"
#include "../common/JavaScriptParser.h"
#include "../common/JavaScriptParserBaseVisitor.h"
#include "../common/JavaScriptParserVisitor.h"
...
public:
    ...
    // 获取解析树
    JavaScriptParser::ProgramContext *getParseTree() { return tree; }
